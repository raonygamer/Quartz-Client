...
namespace quartz::client
{
    ...
    std::string runtimeFormatAbsoluteAddress(RuntimeX86Mode mode, std::uintptr_t address);
    std::string runtimeFormatProcessAddress(RuntimeX86Mode mode, std::span<const RuntimeProcessModule> modules, std::uintptr_t address);
