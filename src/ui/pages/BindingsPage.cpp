...
namespace quartz::client::ui
{
    ...
    void BindingsPage::render(PageContext& context, PageManager& manager)
    {
        ...
        if (ImGui::CollapsingHeader("Quick create", ImGuiTreeNodeFlags_DefaultOpen))
        {
            ...
            if (ImGui::SmallButton("Script")) { auto* b = addPreset("QuickJS script", RuntimeSourceKind::Script, 0, "runtime.script"); b->WriteMaterial = false; b->Clamp = false; b->SmoothingHz = 0.0f; std::snprintf(b->Script, sizeof(b->Script), "return q.previous;"); }
