...
namespace quartz::client::ui
{
    ...
    {
        auto& settings=context.settings; const auto sentFrames=context.sentFrames; const auto droppedFrames=context.droppedFrames; const auto appCpuUsage=context.appCpuUsage; auto& deviceState=context.deviceState; PerformanceSnapshot performance{}; bool hasPerformance=false; std::uint64_t receivedPackets=0;
